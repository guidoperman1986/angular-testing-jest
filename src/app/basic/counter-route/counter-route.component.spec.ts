...
describe('CounterRouteComponent', () => {
  ...
  test('should have initial value in 0', async () => {
  ...
  test('should have initial value in 100 in the route /counter/100', async () => {
  ...
  test('should have initial value in 100 in the route /counter/20abc', async () => {
    const mockActivatedRoute = {
      snapshot: {
        paramMap: {
          get(param: string){
